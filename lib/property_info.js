(function() {
  var BooleanPropertyConverter, IntegerPropertyConverter, StringPropertyConverter, _;
  ...
  */
    ...
    */
    PropertyInfo.prototype.mongooseSchemaDefinition = function() {
      ...
      switch (dt) {
        ...
        case "integer":
          return new IntegerPropertyConverter().convert(this.propertySchema);
        case "boolean":
          return new BooleanPropertyConverter().convert(this.propertySchema);
        default:
          res = {
  ...
  BooleanPropertyConverter = (function() {
    function BooleanPropertyConverter() {}
    BooleanPropertyConverter.prototype.convert = function(propertySchema) {
      var res, validators;
      validators = [];
      res = {
        type: Boolean,
    ...
    return BooleanPropertyConverter;
  })();
  IntegerPropertyConverter = (function() {
    function IntegerPropertyConverter() {}
    IntegerPropertyConverter.prototype.convert = function(propertySchema) {
      var enums, res, validators, x, _i, _len, _ref;
      validators = [];
      if (propertySchema.exclusiveMinimum && !!propertySchema.minimum) {
        validators.push(function(v) {
          return v > propertySchema.minimum;
        });
      }
      if (propertySchema.exclusiveMaximum && !!propertySchema.maximum) {
        validators.push(function(v) {
          return v > propertySchema.maximum;
        });
      }
      enums = null;
      ...
      res = {
        ...
        unique: !!propertySchema.uniqueIndex,
        sparse: !!propertySchema.sparseIndex,
        min: !propertySchema.exclusiveMinimum && !!propertySchema.minimum ? propertySchema.minimum : null,
        max: !propertySchema.exclusiveMaximum && !!propertySchema.maximum ? propertySchema.maximum : null
      };
      return res;
    };
    return IntegerPropertyConverter;
  })();
  /**
